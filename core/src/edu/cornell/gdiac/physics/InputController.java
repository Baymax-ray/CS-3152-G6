...
public class InputController {
	...
	//<editor-fold desc="FIELDS TO MANAGE BUTTONS">
	...
	/**
	 * Returns if the switch button has been pressed
	 *
	 * @return switchPressed boolean
	 */
	...
	public void readInput(Rectangle bounds, Vector2 scale) {
		...
		primePrevious  = jumpPressed;
		secondPrevious = actionPressed;
	...
	private void readKeyboard(Rectangle bounds, Vector2 scale, boolean secondary) {
		...
		jumpPressed = (secondary && jumpPressed) ||  (Gdx.input.isKeyPressed(Input.Keys.SPACE));
